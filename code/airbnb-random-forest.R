...
data_dir="/Users/mariam/Desktop/DA_3/Assignments/airbnb_berlin/data"
...
data <- read_csv(paste(data_out,"airbnb_berlin_workfile_adj.csv", sep = "")) %>%
...
# We focus on normal apartments, 2:6
data <- data %>% filter(data$n_accommodates %in% (2:6))
